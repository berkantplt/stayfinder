...
<div class="container">
    <div>
        ...
        @include('partials.breadcrumb', ['schema' => false, 'root' => ['name' => 'Panel', 'url' => route('agency.dashboard')], 'items' => [['name' => 'Kategori Yetkileri', 'url' => route('agency.category-licenses.index')], ['name' => 'Satın Alımlar']]])
