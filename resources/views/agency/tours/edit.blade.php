...
<div class="container">
    <div>
        ...
        <div class="section" style="padding:0;">
            ...
            // Tükendi işaretli mevcut tarihler (TourDate.label) + validasyon sonrası eski girdi
            const initialSoldDates = @json(old('sold_out_dates', $tour->dates->filter(fn($d) => $d->label === 'Tükendi')->map(fn($d) => $d->departure_date?->format('Y-m-d'))->filter()->values()->all()));
