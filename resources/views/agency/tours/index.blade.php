    ...
    <div>
        ...
        <div class="section" style="padding:24px 0 0 0;">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:30px;max-width:94%;margin-left:auto;margin-right:auto;">
                ...
                <a href="{{ route('agency.tours.create') }}" class="btn btn-primary" style="padding:10px 20px;font-size:15px;box-shadow:0 8px 20px -6px rgba(16,185,129,0.4);">
            ...
            <div style="overflow-x:auto;">
                <table class="table" style="width:100%;text-align:left;">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr><td colspan="6" style="text-align:center;color:#94a3b8;padding:40px;">Henüz tur eklemediniz.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
