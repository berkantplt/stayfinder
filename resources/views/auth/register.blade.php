...
<div class="container" style="max-width:460px;padding-top:80px;padding-bottom:100px;position:relative;z-index:10;">
    <div style="background:rgba(255,255,255,0.95);backdrop-filter:blur(16px);border-radius:24px;padding:48px 40px;box-shadow:0 25px 50px -12px rgba(0,0,0,0.25), 0 0 0 1px rgba(255,255,255,0.5);">
        ...
        <div style="text-align:center;margin-bottom:32px;">
            ...
            <p style="color:#475569;font-size:15px;">Ücretsiz hesap oluşturun</p>
        </div>
        ...
        <form method="POST" action="{{ route('register.post') }}">
            ...
            <div class="form-group" style="margin-bottom:20px;">
                <label style="font-size:14px;font-weight:600;color:#334155;margin-bottom:8px;display:block;">Ad Soyad</label>
            ...
            <button type="submit" class="btn btn-primary" style="width:100%;justify-content:center;padding:14px;font-size:16px;font-weight:700;border-radius:12px;box-shadow:0 4px 12px rgba(13, 116, 144, 0.3);">Kayıt Ol</button>
        </form>
